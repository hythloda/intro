...
const DOC_ID = "14_PKgo4RFujYQYPor-Af28FcqlzslDbbe-JrXMwIeX8";
...
const outputPath = path.join(process.cwd(), "featured-app-overage-policy.html");

const response = await fetch(EXPORT_URL, {
  headers: {
    "User-Agent": "canton-featured-app-overage-policy-sync/1.0",
  },
});
...
<head>
  ...
  <title>FA Overage Policy | Canton Network</title>

  <style>
    :root {
      --bg: #06014a;
      --panel: rgba(6, 4, 30, 0.92);
